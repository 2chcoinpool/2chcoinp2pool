...
nets = dict(
    ...
    dvachcoin=math.Object(
        PARENT=networks.nets['dvachcoin'],
        ...
        IDENTIFIER='fc30135c7a81bc6f'.decode('hex'),
        PREFIX='9471ef181efcd37b'.decode('hex'),
        P2P_PORT=8376,
        MIN_TARGET=0,
        MAX_TARGET=2**256//2**20 - 1,
        PERSIST=False,
        WORKER_PORT=8377,
        BOOTSTRAP_ADDRS='95.85.20.95 46.165.240.133'.split(' '),
        #ANNOUNCE_CHANNEL='#p2pool',
        VERSION_CHECK=lambda v: True,
    ),
    dvachcoin_testnet=math.Object(
        PARENT=networks.nets['dvachcoin_testnet'],
        SHARE_PERIOD=15, # seconds
        NEW_SHARE_PERIOD=15, # seconds
        CHAIN_LENGTH=24*60*60//10, # shares
        REAL_CHAIN_LENGTH=24*60*60//10, # shares
        ...
        SPREAD=30, # blocks
        NEW_SPREAD=30, # blocks
        IDENTIFIER='fc75235c7a81bc6f'.decode('hex'),
        PREFIX='8478ef181efcd37b'.decode('hex'),
        P2P_PORT=18371,
        MIN_TARGET=0,
        MAX_TARGET=2**256//2**20 - 1,
        PERSIST=False,
